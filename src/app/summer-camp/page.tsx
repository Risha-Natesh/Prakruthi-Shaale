      ...
      <main className="pt-20">
        <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            <h1 className="text-lg md:text-xl font-black mb-4 tracking-tighter drop-shadow-2xl">
              Panchavati <span className="text-accent">Summer Camp 2026</span>
            </h1>
            <p className="text-base md:text-lg font-light mb-2 text-white/90">
        ...
        <section className="py-16 container mx-auto px-4">
          <ScrollSection className="max-w-4xl mx-auto text-center">
            <h2 className="text-base md:text-lg font-bold mb-6">About the Camp</h2>
        ...
        <section className="py-16 bg-black/10">
          <div className="container mx-auto px-4">
            <ScrollSection className="text-center mb-10">
              <h2 className="text-base md:text-lg font-bold">Age Groups</h2>
            </ScrollSection>
              ...
              <ScrollSection className="delay-100">
                <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:scale-105 transition-transform duration-500">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-sm font-bold mb-2 text-white">Juniors</h3>
              ...
              <ScrollSection className="delay-300">
                <Card className="bg-white/10 backdrop-blur-md border-white/20 hover:scale-105 transition-transform duration-500">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-sm font-bold mb-2 text-white">Seniors</h3>
        ...
        <section className="py-16 container mx-auto px-4">
          <ScrollSection className="text-center mb-12">
            <h2 className="text-base md:text-lg font-bold">What We'll Explore</h2>
          </ScrollSection>
        ...
        <section className="py-16 bg-accent/10">
          <div className="container mx-auto px-4">
            <ScrollSection className="text-center mb-12">
              <h2 className="text-base md:text-lg font-bold">Special Highlights</h2>
            </ScrollSection>
              ...
              {highlights.map((h, idx) => (
                <ScrollSection key={idx} className="h-full">
                  <div className="p-5 rounded-2xl bg-background/50 backdrop-blur-sm border border-white/5 text-center h-full hover:shadow-xl transition-all">
                    ...
                    <h4 className="font-bold text-xs mb-2">{h.title}</h4>
        ...
        <section className="py-16 container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            <ScrollSection>
              <h2 className="text-base md:text-lg font-bold mb-6">Daily Schedule</h2>
            ...
            <ScrollSection>
              <h2 className="text-base md:text-lg font-bold mb-6">Available Batches</h2>
        ...
        <section className="py-16 bg-black/20">
          <div className="container mx-auto px-4 max-w-4xl">
            <ScrollSection className="text-center mb-10">
              <h2 className="text-base md:text-lg font-bold">What to Expect</h2>
            </ScrollSection>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <ScrollSection>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-base md:text-lg font-bold">Cancellation Policy</h2>
                </div>
        ...
        <section id="register" className="py-24 bg-accent/30 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-10 text-center">
            <ScrollSection className="max-w-2xl mx-auto">
              <h2 className="text-base md:text-lg font-black mb-6">Secure Your Spot!</h2>
              ...
              <a 
                href="https://forms.gle/ur6Pt9GLeMrsqAyy6" 
                target="_blank" 
        ...
        <section className="py-16 bg-white/5">
          <div className="container mx-auto px-4 max-w-3xl">
            <ScrollSection className="text-center mb-10">
              <h2 className="text-base md:text-lg font-bold">Frequently Asked Questions</h2>
            </ScrollSection>
            <ScrollSection>
