        ...
        <div className="container mx-auto py-12 md:py-16 px-4">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="mb-12 text-center">
              ...
              <p className="text-base md:text-lg text-primary-foreground/90 mt-4">
            ...
            <div className="mb-12 p-6 md:p-8 rounded-lg bg-secondary">
              <div className="max-w-3xl mx-auto text-left">
                ...
                <ul className="list-decimal list-outside space-y-2 text-sm md:text-base text-foreground/80 pl-5">
                ...
                <p className="text-sm md:text-base text-foreground/80 mt-6">
            ...
            <div className="mb-12">
              ...
              <p className="text-sm md:text-base text-primary-foreground/90 mb-6 text-center">
                ...
                {engagementModels.map((model, index) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-accent/20 flex items-center justify-center flex-shrink-0">
                      <model.icon className="w-5 h-5 text-accent" />
                    </div>
              ...
              <p className="text-sm md:text-base text-primary-foreground/90 mt-6 font-semibold text-center">
            ...
            <div className="mb-12 p-6 md:p-8 rounded-lg bg-secondary">
              <div className="max-w-3xl mx-auto text-left">
                ...
                <p className="text-sm md:text-base text-foreground/80 mb-4">Teams participate in:</p>
                <ul className="list-decimal list-outside space-y-2 text-sm md:text-base text-foreground/80 pl-5">
                ...
                <p className="text-sm md:text-base text-foreground/80 max-w-3xl mt-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {outcomes.map((outcome, index) => (
                  <div
                    key={index}
                    className={cn(
                      'flex items-center gap-3 p-4 rounded-lg bg-accent/10 text-sm md:text-base',
                      outcomes.length % 2 !== 0 &&
            ...
            <div className="text-center mt-16 p-6 md:p-8 rounded-lg bg-accent/10">
              ...
              <p className="text-sm md:text-base text-primary-foreground/90 mb-6 max-w-3xl mx-auto">
              ...
              <Button size="sm" onClick={handleContactScroll}>
